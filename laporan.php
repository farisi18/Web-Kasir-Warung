...
<button onclick="printTable()" style="padding: 5px 20px; font-size: 16px; background-color: secondary; color: black; border: none; cursor: pointer; border-radius: 4px;">
    Cetak
</button>
<div class="card">
...
<script>
    function printTable() {
        ...
        printWindow.document.write('<html><head><title>Data Laporan</title></head><body>');
        printWindow.document.write('<table>' + tableBody + '</table>');
